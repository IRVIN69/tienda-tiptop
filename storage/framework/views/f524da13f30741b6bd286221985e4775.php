                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <center><?php echo e($categoria->id); ?></center>
                                    </td>
                                        ...
                                        <center>
                                            <div class="btn-group">
                                                ...
                                                <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                                    data-bs-target="#modal-edit-<?php echo e($categoria->id); ?>"><i
                                                        class="fa fa-pencil-alt"></i>Editar</button>

                                                <!-- Modal para editar categoría específico para cada categoría -->
                                                <div class="modal fade" id="modal-edit-<?php echo e($categoria->id); ?>" tabindex="-1"
                                                        ...
                                                        <div class="modal-content">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="nombre_categoria_<?php echo e($categoria->id); ?>">Nombre
                                                                                de la categoría</label>
                                                                            <!-- Input único por cada categoría -->
                                                                            <input type="text"
                                                                                id="nombre_categoria_<?php echo e($categoria->id); ?>"
                                                                                class="form-control"
                                                                                value="<?php echo e($categoria->nombre_categoria); ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" class="btn btn-primary"
                                                                    onclick="updateCategoria(<?php echo e($categoria->id); ?>)">Guardar</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <button type="button" class="btn btn-danger"
                                                    onclick="deleteCategoria(<?php echo e($categoria->id); ?>)">
            ...
            <script>
                $('#btn_create').click(function() {
                    ...
                    if(nombre_categoria==""){
                        ...
                        $.ajax({
                        url: "<?php echo e(route('categoria.store')); ?>",
                        type: "POST",
                        data: {
                ...
                function deleteCategoria(id) {
                    ...
                    if (confirm('¿Estás seguro de que deseas eliminar esta categoría?')) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                _token: "<?php echo e(csrf_token()); ?>" // Token CSRF para protección
                            },
                            success: function(response) {
...
<?php echo $__env->make('layout.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TipTop\resources\views/categorias/index.blade.php ENDPATH**/ ?>