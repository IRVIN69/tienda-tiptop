...
<head>
    ...
    <title><?php echo $__env->yieldContent('titulo'); ?></title><!--parte cambiante con yield-->
    ...
    <div class=" wrapper  ">
        ...
        <nav id="navprincipal" class="main-header navbar navbar-expand navbar-light navbar-white">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li>
                    <form action="<?php echo e(route('logout')); ?>" method="post" class="col-2">
                        <?php echo csrf_field(); ?><!-- crea un token de seguridad-->
        ...
        <aside class="main-sidebar  sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="<?php echo e(route('home')); ?>" style="text-decoration:none;" class="brand-link">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li
                            class="nav-item <?php echo e(request()->is('usuario*') || request()->is('permiso*') || request()->is('rol*') ? 'menu-open' : ''); ?>">
                            <a href=""
                                class="nav-link <?php echo e(request()->is('usuario*') || request()->is('permisos*') || request()->is('roles*') ? 'active' : ''); ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permiso.index')): ?>
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('permiso.index')); ?>"
                                            class="nav-link <?php echo e(request()->is('permiso*') ? 'active' : ''); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role.index')): ?>
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('role.index')); ?>"
                                            class="nav-link <?php echo e(request()->is('rol*') ? 'active' : ''); ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Roles</p>
                                        </a>
                                    <?php endif; ?>
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(route('usuario.index')); ?>"
                                        class="nav-link <?php echo e(request()->is('usuario*') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Usuario</p>
                                    </a>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(route('producto.index')); ?>" class="nav-link ">
                                        <i class="far fa-circle nav-icon"></i>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(route('producto.create')); ?>" class="nav-link ">
                                        <i class="far fa-circle nav-icon"></i>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <?php echo $__env->yieldContent('contenido'); ?><!--PARA cambiar este contenido en otra vista-->
            </section>
            <!-- /.content -->
        </div>
        <!-- /.content-wrapper -->
...
<?php /**PATH C:\xampp\htdocs\TipTop\resources\views/layout/plantilla.blade.php ENDPATH**/ ?>